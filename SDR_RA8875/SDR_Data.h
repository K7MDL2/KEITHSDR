...
struct Band_Memory bandmem[BANDS] = { 
    ...
    #endif
    { "30M", 9990000,10150000,10000000,10136000,VFO_A,DATA, USB, BW3_2, BAND5, 1,AGC_SLOW,OFF, ON,0,OFF,0,OFF,ANT1, 4,  ATTEN_ON,   1,   10,  PREAMP_OFF,  0,  4,  8},
    { "20M",14000000,14350000,14074000,14200000,VFO_A,DATA, USB, BW4_0, BAND6, 3,AGC_SLOW,OFF,OFF,0, ON,0,OFF,ANT2, 5,  ATTEN_ON,   1,   50,  PREAMP_OFF,  0,  5,  8},
