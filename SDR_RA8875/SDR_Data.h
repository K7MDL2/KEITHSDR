...
struct Band_Memory bandmem[BANDS] = { 
    ...
    #else 
    { "40M", 7000000,  7300000,  7074000, DATA,  7030000, CW,    7200000, LSB,  7200000, LSB, BW4_0, BAND40M,   3,AGC_SLOW,OFF,OFF,0,OFF,0,OFF,ANT2, 3,  ATTEN_ON,   1,   20,  PREAMP_OFF,  0,  3,  5},
    #endif
