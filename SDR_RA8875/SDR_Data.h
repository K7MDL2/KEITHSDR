...
struct Band_Memory bandmem[BANDS] = { 
    ...
    #endif
    { "30M", 9990000, 10150000, 10000000, AM,   10136000, USB,  10130000, CW,  10136000, USB, BW3_2, BAND30M,   1,AGC_SLOW,OFF,OFF,0,OFF,0,OFF,ANT1, 4,  ATTEN_OFF,  1,   10,  PREAMP_OFF,  0,  4,  5},
