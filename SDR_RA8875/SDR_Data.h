...
struct Band_Memory bandmem[BANDS] = { 
    ...
    #ifdef PANADAPTER
    { "40M", 8000000, 8500000, 8215000, 8215000,VFO_A, USB, USB, BW3_2, BAND40M,   1,AGC_SLOW,OFF,OFF,0,OFF,0,OFF,ANT1, 3,  ATTEN_ON,   1,   20,  PREAMP_OFF,  0,  3,  8},
    #else 
    { "40M", 7000000, 7300000, 7074000, 7200000,VFO_A,DATA, LSB, BW4_0, BAND40M,   3,AGC_SLOW, ON,OFF,0,OFF,0, ON,ANT2, 3,  ATTEN_ON,   1,   20,  PREAMP_OFF,  0,  3,  8},
    #endif
    { "30M", 9990000,10150000,10000000,10136000,VFO_A,DATA, USB, BW3_2, BAND30M,   1,AGC_SLOW,OFF,OFF,0,OFF,0,OFF,ANT1, 4,  ATTEN_ON,   1,   10,  PREAMP_OFF,  0,  4,  8},
    { "20M",14000000,14350000,14074000,14200000,VFO_A,DATA, USB, BW4_0, BAND20M,   3,AGC_SLOW,OFF,OFF,0,OFF,0,OFF,ANT2, 5,  ATTEN_ON,   1,   50,  PREAMP_OFF,  0,  5,  8},
    { "17M",18068000,18168000,18100000,18135000,VFO_B,DATA, USB, BW3_2, BAND17M,   1,AGC_SLOW,OFF,OFF,0,OFF,0,OFF,ANT1, 6,  ATTEN_ON,   1,   50,  PREAMP_OFF,  0,  6,  8},
    { "15M",21000000,21450000,21074000,21350000,VFO_A,DATA, USB, BW4_0, BAND15M,   3,AGC_SLOW,OFF,OFF,0,OFF,0,OFF,ANT1, 7,  ATTEN_OFF,  0,    0,  PREAMP_OFF,  0,  7,  8},
    { "12M",24890000,24990000,24915000,24904000,VFO_B, USB, USB, BW3_2, BAND12M,   1,AGC_SLOW,OFF,OFF,0,OFF,0,OFF,ANT1, 8,  ATTEN_OFF,  0,    0,  PREAMP_ON,   0,  8,  8},
    { "10M",28000000,29600000,28074000,28200000,VFO_A,DATA, USB, BW4_0, BAND10M,   1,AGC_SLOW,OFF,OFF,0,OFF,0,OFF,ANT1, 9,  ATTEN_OFF,  0,    0,  PREAMP_ON,   0,  9,  8},
    {  "6M",50000000,54000000,50125000,50313000,VFO_A, USB,DATA, BW3_2, BAND6M,    1,AGC_SLOW,OFF,OFF,0,OFF,0,OFF,ANT1,10,  ATTEN_OFF,  0,    0,  PREAMP_OFF,  0, 10,  8},
    {  "IF", 8200000, 8300000, 8215000, 8215000,VFO_A, USB, LSB, BW2_8, PAN_ADAPT, 1,AGC_SLOW,OFF,OFF,0,OFF,0,OFF,ANT1, 0,  ATTEN_OFF,  0,   50,  PREAMP_OFF,  0,  0,  8}
};
