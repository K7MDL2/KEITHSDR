...
struct Band_Memory bandmem[BANDS] = { 
    // name    lower   upper    VFOA     VFOB  modeA modeB filt   band     ts   agc  SPLIT RT RV XT XV ATU ANT BPF  ATTEN   AttByp att_DB  PREAMP    XVE XV#  SpRef
    {"160M", 1800000, 2000000, 1840000, 1860000,DATA, LSB, BW4_0, BAND160M,  1,AGC_SLOW,OFF,OFF,0,OFF,0,OFF,ANT1, 0,  ATTEN_ON,   1,   80,  PREAMP_OFF,  0,  0,  8},
    { "80M", 3500000, 4000000, 3573000, 3868000,DATA, LSB, BW3_2, BAND80M,   1,AGC_SLOW,OFF,OFF,0,OFF,0,OFF,ANT1, 1,  ATTEN_ON,   1,   40,  PREAMP_OFF,  0,  1,  5},
    { "60M", 4990000, 5367000, 5000000, 5366000,USB,  USB, BW3_2, BAND60M,   1,AGC_SLOW,OFF,OFF,0,OFF,0,OFF,ANT1, 2,  ATTEN_ON,   1,   40,  PREAMP_OFF,  0,  2,  8},
    #ifdef PANADAPTER
    { "40M", 8000000, 8500000, 8215000, 8215000,USB,  USB, BW3_2, BAND40M,   1,AGC_SLOW,OFF,OFF,0,OFF,0,OFF,ANT1, 3,  ATTEN_ON,   1,   20,  PREAMP_OFF,  0,  3,  8},
    #else 
    { "40M", 7000000, 7300000, 7074000, 7200000,DATA, LSB, BW4_0, BAND40M,   3,AGC_SLOW, ON,OFF,0,OFF,0, ON,ANT2, 3,  ATTEN_ON,   1,   20,  PREAMP_OFF,  0,  3,  8},
    #endif
    { "30M", 9990000,10150000,10000000,10136000,DATA, USB, BW3_2, BAND30M,   1,AGC_SLOW,OFF,OFF,0,OFF,0,OFF,ANT1, 4,  ATTEN_ON,   1,   10,  PREAMP_OFF,  0,  4,  8},
    { "20M",14000000,14350000,14074000,14200000,DATA, USB, BW4_0, BAND20M,   3,AGC_SLOW,OFF,OFF,0,OFF,0,OFF,ANT2, 5,  ATTEN_ON,   1,   50,  PREAMP_OFF,  0,  5,  8},
    { "17M",18068000,18168000,18100000,18135000,DATA, USB, BW3_2, BAND17M,   1,AGC_SLOW,OFF,OFF,0,OFF,0,OFF,ANT1, 6,  ATTEN_ON,   1,   50,  PREAMP_OFF,  0,  6,  8},
    { "15M",21000000,21450000,21074000,21350000,DATA, USB, BW4_0, BAND15M,   3,AGC_SLOW,OFF,OFF,0,OFF,0,OFF,ANT1, 7,  ATTEN_OFF,  0,    0,  PREAMP_OFF,  0,  7,  8},
    { "12M",24890000,24990000,24915000,24904000,USB,  USB, BW3_2, BAND12M,   1,AGC_SLOW,OFF,OFF,0,OFF,0,OFF,ANT1, 8,  ATTEN_OFF,  0,    0,  PREAMP_ON,   0,  8,  8},
    { "10M",28000000,29600000,28074000,28200000,DATA, USB, BW4_0, BAND10M,   1,AGC_SLOW,OFF,OFF,0,OFF,0,OFF,ANT1, 9,  ATTEN_OFF,  0,    0,  PREAMP_ON,   0,  9,  8},
    {  "6M",50000000,54000000,50125000,50313000,USB, DATA, BW3_2, BAND6M,    1,AGC_SLOW,OFF,OFF,0,OFF,0,OFF,ANT1,10,  ATTEN_OFF,  0,    0,  PREAMP_OFF,  0, 10,  8},
    {  "IF", 8200000, 8300000, 8215000, 8215000,USB,  LSB, BW2_8, PAN_ADAPT, 1,AGC_SLOW,OFF,OFF,0,OFF,0,OFF,ANT1, 0,  ATTEN_OFF,  0,   50,  PREAMP_OFF,  0,  0,  8}
};
