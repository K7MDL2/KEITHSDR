...
struct Band_Memory bandmem[BANDS] = {
    ...
    { "80M",     3500000,     4000000,     3573000, DATA,     3868000, LSB,      3813000,  LSB,     3868000, LSB,  BW3_2, 3200,  BAND80M,  1, AGC_SLOW,OFF,OFF,OFF,OFF,ANT1, 1,  ATTEN_OFF,  0,   20,  PREAMP_OFF,  5,  ON,   NONE,    NONE,    100,  -10,  0xFFFF},
    { "60M",     4990000,     5405000,     5000000, AM,       5287200, LSB,      5364700,  LSB,     5405000, USB,  BW6_0, 6000,  BAND60M,  1, AGC_SLOW,OFF,OFF,OFF,OFF,ANT1, 2,  ATTEN_OFF,  0,   10,  PREAMP_OFF,  5,  ON,   NONE,    NONE,    100,  -10,  0xFFFF},
    { "40M",     7000000,     7300000,     7074000, DATA,     7030000, CW,       7200000,  LSB,     7200000, LSB,  BW3_2, 3200,  BAND40M,  3, AGC_SLOW,OFF,OFF,OFF,OFF,ANT2, 3,  ATTEN_OFF,  0,   10,  PREAMP_OFF,  5,  ON,   NONE,    NONE,    100,  -10,  0xFFFF},
    { "30M",     9990000,    10150000,    10000000, AM,      10136000, DATA,    10130000,  CW,     10136000, USB,  BW6_0, 6000,  BAND30M,  1, AGC_SLOW,OFF,OFF,OFF,OFF,ANT1, 4,  ATTEN_OFF,  0,   10,  PREAMP_OFF,  5,  ON,   NONE,    NONE,    100,  -10,  0xFFFF},
    { "20M",    14000000,    14350000,    14074000, DATA,    14030000, CW,      14200000,  USB,    14200000, USB,  BW4_0, 4000,  BAND20M,  3, AGC_SLOW,OFF,OFF,OFF,OFF,ANT2, 5,  ATTEN_OFF,  0,   10,  PREAMP_OFF,  5,  ON,   NONE,    NONE,    100,  -10,  0xFFFF},
    { "17M",    18068000,    18168000,    18100000, DATA,    18135000, USB,     18090000,  CW,     18135000, USB,  BW3_2, 3200,  BAND17M,  1, AGC_SLOW,OFF,OFF,OFF,OFF,ANT1, 6,  ATTEN_ON,   1,   14,  PREAMP_ON,   5,  ON,   NONE,    NONE,    100,  -10,  0xFFFF},
    { "15M",    21000000,    21450000,    21074000, DATA,    21030000, CW,      21300000,  USB,    21350000, USB,  BW3_2, 3200,  BAND15M,  3, AGC_SLOW,OFF,OFF,OFF,OFF,ANT1, 7,  ATTEN_ON,   1,    3,  PREAMP_ON,   5,  ON,   NONE,    NONE,    100,  -10,  0xFFFF},
    { "12M",    24890000,    24990000,    24915000, USB,     24892000, CW,      24950000,  USB,    24904000, USB,  BW3_2, 3200,  BAND12M,  1, AGC_SLOW,OFF,OFF,OFF,OFF,ANT1, 8,  ATTEN_ON,   1,    3,  PREAMP_ON,   5,  ON,   NONE,    NONE,    100,  -10,  0xFFFF},
    ...
    {  "6M",    50000000,    54000000,    50125000, USB,     50313000, DATA,    50100000,  CW,     50313000, DATA, BW3_2, 3200,  BAND6M,   1, AGC_SLOW,OFF,OFF,OFF,OFF,ANT1,10,  ATTEN_OFF,  0,    0,  PREAMP_ON,   5,  ON,   NONE,    NONE,     30,  -10,  0x0001},
    { "144",   144000000,   148000000,   144200000, USB,    144200000, DATA,   144200000,  CW,    144200000, DATA, BW3_2, 3200,  BAND144,  1, AGC_SLOW,OFF,OFF,OFF,OFF,ANT1,10,  ATTEN_ON,   1,    3,  PREAMP_ON,   5,  OFF,  XVTR2,   BAND10M,  10,  -10,  0x0002},
