...
struct Band_Memory bandmem[BANDS] = { 
    ...
    { "60M", 4990000, 5367000, 5000000, 5366000,AM,   USB, BW3_2, BAND60M,   1,AGC_SLOW,OFF,OFF,0,OFF,0,OFF,ANT1, 2,  ATTEN_ON,   1,   40,  PREAMP_OFF,  0,  2,  8},
    #ifdef PANADAPTER
    ...
    #else 
    { "40M", 7000000, 7300000, 7074000, 7200000,DATA, LSB, BW4_0, BAND40M,   3,AGC_SLOW,OFF,OFF,0,OFF,0, ON,ANT2, 3,  ATTEN_ON,   1,   20,  PREAMP_OFF,  0,  3,  8},
    #endif
    { "30M", 9990000,10150000,10000000,10136000,AM,   USB, BW3_2, BAND30M,   1,AGC_SLOW,OFF,OFF,0,OFF,0,OFF,ANT1, 4,  ATTEN_ON,   1,   10,  PREAMP_OFF,  0,  4,  8},
