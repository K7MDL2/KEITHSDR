...
struct Band_Memory {
    ...
    {"160M", 1800000, 2000000, 1840000, 1860000, LSB, BW2_8, BAND0,4,AGC_SLOW,OFF,OFF,OFF,OFF,ANT1, PRESEL1,ATTEN_OFF,PREAMP_OFF,MIC_OFF,1.0,ON,15,ON,1.0,ON,20,OFF,0, 0 },
