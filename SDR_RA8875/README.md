...
## March 2022
    ...
    15. Known Issue: For RS-HFIQ, if the new band has VFOB active, and the previous band had VFOA active, a serial port frequency change updates the VFOA not VFOB (freq changed before the band changed to know which VFO is active).
