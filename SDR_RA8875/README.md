...
## Feb 2022
    ...
    38. Added long press on RFGain button.  doing so wil ltoggle PAN oand and off. user_settings nwo has 2 new field, apn_state (ON/OFF) and pan_level. The RFGain control is doing double duty as one or the other. I have enabled PAN on by default for user profile1 (default user).  Toggle off (long press the RFGain button to adjust the real RFGain.  Ths is tempeorry until I add PAN and ZOOm to the MF knob.
