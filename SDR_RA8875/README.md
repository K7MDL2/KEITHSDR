...
## June 2022
    ...
    6. The USB Audio is reporting as 44.1KHz despite earlier testing where it was 48Khz. The CWkeyer project has a modified versoin of the TeensyDuino Audio lib and cores files to change from the default 44.1KHz to 48KHz. It also gives a custom USB device name "KeyerShield". I am guessing the F32 library is overriding thise.  Investigating still.
