...
struct Band_Memory {
    ...
    {"160M", 1800000, 2000000, 1840000, 1860000,VFO_A, LSB, LSB, BW2_8, BAND0,1,AGC_SLOW,OFF,OFF,0,OFF,0,OFF,ANT1, HF160,   ATTEN_OFF,PREAMP_OFF, 0,  0},
    { "80M", 3500000, 4000000, 3573000, 3830000,VFO_A, LSB, LSB, BW3_2, BAND1,1,AGC_SLOW,OFF,OFF,0,OFF,0,OFF,ANT1, HF80,    ATTEN_OFF,PREAMP_OFF, 0,  1},
    { "60M", 5350000, 5367000, 5000000, 5366000,VFO_B, USB, USB, BW3_2, BAND2,1,AGC_SLOW,OFF,OFF,0,OFF,0,OFF,ANT1, HF60,    ATTEN_OFF,PREAMP_OFF, 0,  2},
    { "40M", 7000000, 7300000, 7074000, 7200000,VFO_A,DATA, LSB, BW4_0, BAND3,1,AGC_SLOW,OFF,OFF,0,OFF,0,OFF,ANT1, HF40,    ATTEN_OFF,PREAMP_OFF, 0,  3},
    { "30M",10100000,10150000,10000000,10136000,VFO_A,DATA, USB, BW3_2, BAND4,1,AGC_SLOW,OFF,OFF,0,OFF,0,OFF,ANT1, HF30,    ATTEN_OFF,PREAMP_OFF, 0,  4},
    { "20M",14000000,14350000,14074000,14200000,VFO_A,DATA, USB, BW4_0, BAND5,1,AGC_SLOW,OFF,OFF,0,OFF,0,OFF,ANT1, HF20,    ATTEN_OFF,PREAMP_OFF, 0,  5},
    { "17M",18068000,18168000,18135000,18100000,VFO_A, USB, USB, BW3_2, BAND6,1,AGC_SLOW,OFF,OFF,0,OFF,0,OFF,ANT1, HF17,    ATTEN_OFF,PREAMP_OFF, 0,  6},
    { "15M",21000000,21450000,21074000,21350000,VFO_A,DATA, USB, BW4_0, BAND7,1,AGC_SLOW,OFF,OFF,0,OFF,0,OFF,ANT1, HF15,    ATTEN_OFF,PREAMP_OFF, 0,  7},
    { "12M",24890000,24990000,24915000,24904000,VFO_A,  CW, USB, BW1_8, BAND8,1,AGC_SLOW,OFF,OFF,0,OFF,0,OFF,ANT1, HF12,    ATTEN_OFF,PREAMP_OFF, 0,  8},
    { "10M",28000000,29600000,28074000,28074000,VFO_A,DATA, USB, BW3_2, BAND9,1,AGC_SLOW,OFF,OFF,0,OFF,0,OFF,ANT1, HF10,    ATTEN_OFF,PREAMP_OFF, 0,  9},
    {  "6M",50000000,54000000,50125000,50313000,VFO_A, USB, USB, BW3_2,BAND10,1,AGC_SLOW,OFF,OFF,0,OFF,0,OFF,ANT1, HFBypass,ATTEN_OFF,PREAMP_OFF, 0, 10}
};
