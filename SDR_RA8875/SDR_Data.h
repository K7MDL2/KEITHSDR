...
struct Band_Memory bandmem[BANDS] = { 
    ...
    {"160M", 1800000,  2000000,  1840000, DATA,  1860000, LSB,   1910000, LSB,  1860000, LSB, BW4_0, BAND160M,  1,AGC_SLOW,OFF,OFF,0,OFF,0,OFF,ANT1, 0,  ATTEN_ON,   1,   80,  PREAMP_OFF,  0,  0,  5},
    ...
    { "60M", 4990000,  5405000,  5000000, AM,    5287200, LSB,   5364700, LSB,  5405000, USB, BW3_2, BAND60M,   1,AGC_SLOW,OFF,OFF,0,OFF,0,OFF,ANT1, 2,  ATTEN_ON,   1,   40,  PREAMP_OFF,  0,  2,  5},
    #ifdef PANADAPTER
    { "40M", 8000000,  8500000,  8215000, USB,   8215000, LSB,   8215000, LSB,  8215000, USB, BW3_2, BAND40M,   1,AGC_SLOW,OFF,OFF,0,OFF,0,OFF,ANT1, 3,  ATTEN_ON,   1,   20,  PREAMP_OFF,  0,  3,  5},
    #else 
    { "40M", 7000000,  7300000,  7074000, DATA,  7030000, CW,    7200000, LSB,  7200000, LSB, BW4_0, BAND40M,   3,AGC_SLOW,OFF,OFF,0,OFF,0, ON,ANT2, 3,  ATTEN_ON,   1,   20,  PREAMP_OFF,  0,  3,  5},
    #endif
    { "30M", 9990000, 10150000, 10000000, AM,   10136000, USB,  10130000, CW,  10136000, USB, BW3_2, BAND30M,   1,AGC_SLOW,OFF,OFF,0,OFF,0,OFF,ANT1, 4,  ATTEN_ON,   1,   10,  PREAMP_OFF,  0,  4,  5},
    { "20M",14000000, 14350000, 14074000, DATA, 14030000, CW ,  14200000, USB, 14200000, USB, BW4_0, BAND20M,   3,AGC_SLOW,OFF,OFF,0,OFF,0,OFF,ANT2, 5,  ATTEN_ON,   1,   50,  PREAMP_OFF,  0,  5,  5},
    { "17M",18068000, 18168000, 18100000, DATA, 18135000, USB,  18090000, CW,  18135000, USB, BW3_2, BAND17M,   1,AGC_SLOW,OFF,OFF,0,OFF,0,OFF,ANT1, 6,  ATTEN_ON,   1,   50,  PREAMP_OFF,  0,  6,  5},
