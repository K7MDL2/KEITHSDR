...
## May 2022
    ...
    10. I tried to make a single place to set the motherboard version, RA8875/76 type and FFT size options but was unsucessful, the library has a mind of its own on these matters.  So I have moved the library back into the main program.  RadioConfig.h has a few more settings moved into it and I cleaned up my K7MDL_BUILD section to incoude only what I am using or testing these days, it is a much smaller  section now. You no longer need to download the Spectrum_RA887x_Library or change any settings in those files.
