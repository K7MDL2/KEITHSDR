...
struct Band_Memory bandmem[BANDS] = {
    // name         lower     upper         VFOA    Md_A       VFOA-1  mode1     VFOA-2     md2      VFOB    modeB filt  varfil  bandnum   ts agc     SPLIT RT  XT ATU ANT   BPF ATTEN   AttByp att_DB   PREAMP    bmap  XV#     Xvtr_IF  SpRef
    {"160M",     1800000,     2000000,     1840000, DATA,     1860000, LSB,      1910000,  LSB,     1860000, LSB,  BW3_2, 3200,  BAND160M, 1, AGC_SLOW,OFF,OFF,OFF,OFF,ANT1, 0,  ATTEN_OFF,  1,   80,  PREAMP_OFF,  OFF, NONE,   NONE,    5},
    { "80M",     3500000,     4000000,     3573000, DATA,     3868000, LSB,      3813000,  LSB,     3868000, LSB,  BW3_2, 3200,  BAND80M,  1, AGC_SLOW,OFF,OFF,OFF,OFF,ANT1, 1,  ATTEN_OFF,  1,   40,  PREAMP_OFF,  ON,  NONE,   NONE,    5},
    { "60M",     4990000,     5405000,     5000000, AM,       5287200, LSB,      5364700,  LSB,     5405000, USB,  BW6_0, 6000,  BAND60M,  1, AGC_SLOW,OFF,OFF,OFF,OFF,ANT1, 2,  ATTEN_OFF,  1,   40,  PREAMP_OFF,  ON,  NONE,   NONE,    5},
    { "40M",     7000000,     7300000,     7074000, DATA,     7030000, CW,       7200000,  LSB,     7200000, LSB,  BW3_2, 3200,  BAND40M,  3, AGC_SLOW,OFF,OFF,OFF,OFF,ANT2, 3,  ATTEN_OFF,  1,   20,  PREAMP_OFF,  ON,  NONE,   NONE,    5},
    { "30M",     9990000,    10150000,    10000000, AM,      10136000, DATA,    10130000,  CW,     10136000, USB,  BW6_0, 6000,  BAND30M,  1, AGC_SLOW,OFF,OFF,OFF,OFF,ANT1, 4,  ATTEN_OFF,  1,   10,  PREAMP_OFF,  ON,  NONE,   NONE,    5},
    { "20M",    14000000,    14350000,    14074000, DATA,    14030000, CW,      14200000,  USB,    14200000, USB,  BW4_0, 4000,  BAND20M,  3, AGC_SLOW,OFF,OFF,OFF,OFF,ANT2, 5,  ATTEN_OFF,  1,   50,  PREAMP_OFF,  ON,  NONE,   NONE,    5},
    { "17M",    18068000,    18168000,    18100000, DATA,    18135000, USB,     18090000,  CW,     18135000, USB,  BW3_2, 3200,  BAND17M,  1, AGC_SLOW,OFF,OFF,OFF,OFF,ANT1, 6,  ATTEN_OFF,  1,   50,  PREAMP_OFF,  ON,  NONE,   NONE,    5},
    { "15M",    21000000,    21450000,    21074000, DATA,    21030000, CW,      21300000,  USB,    21350000, USB,  BW3_2, 3200,  BAND15M,  3, AGC_SLOW,OFF,OFF,OFF,OFF,ANT1, 7,  ATTEN_OFF,  0,    0,  PREAMP_OFF,  ON,  NONE,   NONE,    5},
    { "12M",    24890000,    24990000,    24915000, USB,     24892000, CW,      24950000,  USB,    24904000, USB,  BW3_2, 3200,  BAND12M,  1, AGC_SLOW,OFF,OFF,OFF,OFF,ANT1, 8,  ATTEN_OFF,  0,    0,  PREAMP_ON,   ON,  NONE,   NONE,    5},
    { "10M",    28000000,    29600000,    28074000, DATA,    28200000, USB,     29400000,  USB,    28200000, USB,  BW4_0, 4000,  BAND10M,  1, AGC_SLOW,OFF,OFF,OFF,OFF,ANT1, 9,  ATTEN_OFF,  0,    0,  PREAMP_ON,   ON,  NONE,   NONE,    5},
    {  "6M",    50000000,    54000000,    50125000, USB,     50313000, DATA,    50100000,  CW,     50313000, DATA, BW3_2, 3200,  BAND6M,   1, AGC_SLOW,OFF,OFF,OFF,OFF,ANT1,10,  ATTEN_OFF,  0,    0,  PREAMP_OFF,  OFF, XVTR1,  BAND10M, 5},
    { "144",   144000000,   148000000,   144200000, USB,    144200000, DATA,   144200000,  CW,    144200000, DATA, BW3_2, 3200,  BAND144,  1, AGC_SLOW,OFF,OFF,OFF,OFF,ANT1,10,  ATTEN_OFF,  0,    0,  PREAMP_OFF,  ON,  XVTR2,  BAND15M, 5},
    { "222",   222000000,   225000000,   222100000, USB,    222100000, DATA,   222100000,  CW,    222100000, DATA, BW3_2, 3200,  BAND222,  1, AGC_SLOW,OFF,OFF,OFF,OFF,ANT1,10,  ATTEN_OFF,  0,    0,  PREAMP_OFF,  ON,  XVTR3,  BAND10M, 5},
    { "432",   432000000,   450000000,   432100000, USB,    432100000, DATA,   432100000,  CW,    432100000, DATA, BW3_2, 3200,  BAND432,  1, AGC_SLOW,OFF,OFF,OFF,OFF,ANT1,10,  ATTEN_OFF,  0,    0,  PREAMP_OFF,  ON,  XVTR4,  BAND10M, 5},
    { "903",   902000000,   904000000,   903100000, USB,    903100000, DATA,   903100000,  CW,    903100000, DATA, BW3_2, 3200,  BAND902,  1, AGC_SLOW,OFF,OFF,OFF,OFF,ANT1,10,  ATTEN_OFF,  0,    0,  PREAMP_OFF,  ON,  XVTR5,  BAND10M, 5},
    {"1296",  1296000000,  1298000000,  1296100000, USB,   1296074000, DATA,  1296110000,  CW,   1296120000, USB,  BW3_2, 3200,  BAND1296, 1, AGC_SLOW,OFF,OFF,OFF,OFF,ANT1,10,  ATTEN_OFF,  0,    0,  PREAMP_OFF,  ON,  XVTR6,  BAND10M, 5},
    {"2300",  2304000000,  2306000000,  2304100000, USB,   2304100000, DATA,  2304100000,  CW,   2304100000, DATA, BW3_2, 3200,  BAND2300, 1, AGC_SLOW,OFF,OFF,OFF,OFF,ANT1,10,  ATTEN_OFF,  0,    0,  PREAMP_OFF,  ON,  XVTR7,  BAND10M, 5},
    {"2400",  2400000000,  2402000000,  2400100000, USB,   2400100000, DATA,  2400100000,  CW,   2400100000, DATA, BW3_2, 3200,  BAND2400, 1, AGC_SLOW,OFF,OFF,OFF,OFF,ANT1,10,  ATTEN_OFF,  0,    0,  PREAMP_OFF,  ON,  XVTR8,  BAND10M, 5},
    {"3300",  3400000000,  3402000000,  3400100000, USB,   3400100000, DATA,  3400100000,  CW,   3400100000, DATA, BW3_2, 3200,  BAND3300, 1, AGC_SLOW,OFF,OFF,OFF,OFF,ANT1,10,  ATTEN_OFF,  0,    0,  PREAMP_OFF,  ON,  XVTR9,  BAND10M, 5},
    {"5760",  5760000000,  5762000000,  5760100000, USB,   5760100000, DATA,  5760100000,  CW,   5760100000, DATA, BW3_2, 3200,  BAND5760, 1, AGC_SLOW,OFF,OFF,OFF,OFF,ANT1,10,  ATTEN_OFF,  0,    0,  PREAMP_OFF,  ON,  XVTR10, BAND10M, 5},
    { "10G", 10368000000, 10370000000, 10368100000, USB,  10368100000, DATA, 10368100000,  CW,  10368100000, DATA, BW3_2, 3200,  BAND10G,  1, AGC_SLOW,OFF,OFF,OFF,OFF,ANT1,10,  ATTEN_OFF,  0,    0,  PREAMP_OFF,  ON,  XVTR11, BAND10M, 5},
    { "24G", 24048000000, 24050000000, 24048200000, USB,  24192100000, DATA, 24192100000,  CW,  24192100000, DATA, BW3_2, 3200,  BAND24G,  1, AGC_SLOW,OFF,OFF,OFF,OFF,ANT1,10,  ATTEN_OFF,  0,    0,  PREAMP_OFF,  OFF, XVTR12, BAND10M, 5},
    { "47G", 47000000000, 47002000000, 47000100000, USB,  47000100000, DATA, 47000100000,  CW,  47000100000, DATA, BW3_2, 3200,  BAND47G,  1, AGC_SLOW,OFF,OFF,OFF,OFF,ANT1,10,  ATTEN_OFF,  0,    0,  PREAMP_OFF,  OFF, XVTR13, BAND10M, 5},
    { "PAN",     8200000,     8300000,     8215000, DATA,     8215000, USB,      8215000,  USB,     8215000, LSB,  BW2_8, 2800,  PAN_ADAPT,1, AGC_SLOW,OFF,OFF,OFF,OFF,ANT1, 0,  ATTEN_OFF,  0,   50,  PREAMP_OFF,  OFF, NONE,   NONE,    5}
};
...
struct Frequency_Display disp_Freq[FREQ_DISP_NUM] = {
    ...
    #else
    {304,  1, 360,  50,   3,  0,  0, BLACK,      LIGHTGREY,  BLACK,  LIGHTGREY,  Arial_40, RED,   4,   4}, // VFO Active Digits
    {688,  6,  40,  40,   3,  0,  0, LIGHTGREY,  BLACK,      BLACK,  GREEN,      Arial_24, RED,   9,   7}, // VFO Active VFO Marker (A)
    {410, 53, 254,  40,   3,  0,  0, BLACK,      BLACK,      BLACK,  myDARKGREY, Arial_28, RED,   6,   6}, // VFO Stby Digits
    {688, 53,  40,  40,   3,  0,  0, LIGHTGREY,  BLACK,      BLACK,  myDARKGREY, Arial_24, RED,   9,   7}  // VFO Stby VFO Marker (B)
    #endif  // USE_RA8875
};
