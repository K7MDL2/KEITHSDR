...
struct Band_Memory bandmem[BANDS] = { 
    ...
    { "20M",14000000,14350000,14074000,14200000,VFO_A,DATA, USB, BW4_0, BAND5, 2,AGC_SLOW,OFF,OFF,0, ON,0,OFF,ANT3, 5,  ATTEN_ON,  7,  PREAMP_ON,  0,  5,  -155},
    ...
    { "12M",24890000,24990000,24915000,24904000,VFO_B, USB,  CW, BW0_7, BAND8, 0,AGC_SLOW,OFF,OFF,0,OFF,0,OFF,ANT1, 8,  ATTEN_ON,  4,  PREAMP_ON,  0,  8,  -170},
    ...
    {  "6M",50000000,54000000,50125000,50313000,VFO_A, USB,DATA, BW3_2,BAND10, 2,AGC_SLOW,OFF,OFF,0,OFF,0,OFF,ANT1, 10, ATTEN_ON,  4,  PREAMP_ON,  0, 10,  -145}
};
...
struct User_Settings user_settings[USER_SETTINGS_NUM] = {                      
    ...
    {"User Config #1", 10, 0, OFF,  0,  0,  0, BAND5,  OFF, MIC_OFF, 1.0,  15,   OFF,   100,   ON,   OFF,    80,  ON,  22,   ON,  OFF,  OFF,  NB5,  OFF,  OFF,  0.1,  600, NTCHOFF, OFF, OFF,   0,  MFTUNE,   MFTUNE, RFGAIN_BTN,  ATTEN_BTN}, // if no encoder is present assign it to 0 and it will be skipped. 
    {"User Config #2", 10, 0, OFF,  0,  0,  0, BAND2,  OFF, MIC_OFF, 1.0,  15,   OFF,   100,   ON,   OFF,    80,  ON,  22,  OFF,  OFF,  OFF,  NB2,  NR3,  OFF,  0.1,  600, NTCHOFF, OFF, OFF,   0,  MFTUNE,   MFTUNE, RFGAIN_BTN,  AFGAIN_BTN},
    {"User Config #3",  6, 0, OFF,  0,  0,  0, BAND6,  OFF, MIC_OFF, 1.0,  15,   OFF,   100,   ON,   OFF,    80,  ON,  22,  OFF,  OFF,  OFF,  NB1,  OFF,  OFF,  0.1,  600, NTCHOFF, OFF, OFF,   0,  MFTUNE,   MFTUNE, AFGAIN_BTN,  RFGAIN_BTN}
};
