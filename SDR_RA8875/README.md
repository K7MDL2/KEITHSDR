...
## May 2022
    ...
    11. Added #define INPUT_PULLUP 2 to the SDR_RA8875.h file just before the encoder.h include. This should cause the library to enable the encoder pins with pullups. Default is no pullups. You won't need external pullup resistors with this change.  If you do use external resistors, be sure they are on the right voltage for your CPU. The Teensy 4 is 3.3V.
