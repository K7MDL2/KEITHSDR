...
struct Band_Memory bandmem[BANDS] = { 
    ...
    {  "IF", 8200000, 8300000, 8215000, 8215000,VFO_A, USB, LSB, BW2_8, BAND0, 1,AGC_SLOW,OFF,OFF,0,OFF,0,OFF,ANT1, 0,  ATTEN_OFF,  0,   50,  PREAMP_OFF,  0,  0,  8},
    {"160M", 1800000, 2000000, 1840000, 1860000,VFO_A,DATA, LSB, BW4_0, BAND1, 1,AGC_SLOW,OFF,OFF,0,OFF,0,OFF,ANT1, 0,  ATTEN_ON,   1,   80,  PREAMP_OFF,  0,  0,  8},
    { "80M", 3500000, 4000000, 3573000, 3868000,VFO_A,DATA, LSB, BW3_2, BAND2, 1,AGC_SLOW,OFF,OFF,0,OFF,0,OFF,ANT1, 1,  ATTEN_ON,   1,   40,  PREAMP_OFF,  0,  1,  5},
    { "60M", 4990000, 5367000, 5000000, 5366000,VFO_A, USB, USB, BW3_2, BAND3, 1,AGC_SLOW,OFF,OFF,0,OFF,0,OFF,ANT1, 2,  ATTEN_ON,   1,   40,  PREAMP_OFF,  0,  2,  8},
    #ifdef PANADAPTER
    { "40M", 8000000, 8500000, 8215000, 8215000,VFO_A, USB, USB, BW3_2, BAND4, 1,AGC_SLOW,OFF,OFF,0,OFF,0,OFF,ANT1, 3,  ATTEN_ON,   1,   20,  PREAMP_OFF,  0,  3,  8},
    #else 
    { "40M", 7000000, 7300000, 7074000, 7200000,VFO_A,DATA, LSB, BW4_0, BAND4, 3,AGC_SLOW, ON,OFF,0,OFF,0, ON,ANT2, 3,  ATTEN_ON,   1,   20,  PREAMP_OFF,  0,  3,  8},
    #endif
    { "30M", 9990000,10150000,10000000,10136000,VFO_A,DATA, USB, BW3_2, BAND5, 1,AGC_SLOW,OFF,OFF,0,OFF,0,OFF,ANT1, 4,  ATTEN_ON,   1,   10,  PREAMP_OFF,  0,  4,  8},
    { "20M",14000000,14350000,14074000,14200000,VFO_A,DATA, USB, BW4_0, BAND6, 3,AGC_SLOW,OFF,OFF,0,OFF,0,OFF,ANT2, 5,  ATTEN_ON,   1,   50,  PREAMP_OFF,  0,  5,  8},
    { "17M",18068000,18168000,18100000,18135000,VFO_B,DATA, USB, BW3_2, BAND7, 1,AGC_SLOW,OFF,OFF,0,OFF,0,OFF,ANT1, 6,  ATTEN_ON,   1,   50,  PREAMP_OFF,  0,  6,  8},
    { "15M",21100000,21450000,21074000,21350000,VFO_A,DATA, USB, BW4_0, BAND8, 3,AGC_SLOW,OFF,OFF,0,OFF,0,OFF,ANT1, 7,  ATTEN_OFF,  0,    0,  PREAMP_OFF,  0,  7,  8},
    { "12M",24890000,24990000,24915000,24904000,VFO_B, USB, USB, BW3_2, BAND9, 1,AGC_SLOW,OFF,OFF,0,OFF,0,OFF,ANT1, 8,  ATTEN_OFF,  0,    0,  PREAMP_ON,   0,  8,  8},
    { "10M",28000000,29600000,28074000,28200000,VFO_A,DATA, USB, BW4_0,BAND10, 1,AGC_SLOW,OFF,OFF,0,OFF,0,OFF,ANT1, 9,  ATTEN_OFF,  0,    0,  PREAMP_ON,   0,  9,  8},
    {  "6M",50000000,54000000,50125000,50313000,VFO_A, USB,DATA, BW3_2,BAND11, 1,AGC_SLOW,OFF,OFF,0,OFF,0,OFF,ANT1, 10, ATTEN_OFF,  0,    0,  PREAMP_OFF,  0, 10,  8}
};
...
//Profile name    sp_preset mn  pop uc1 uc2 uc3 lastB  mute  mic_En  micG LInLvl rfg_en rfGain SpkEn afgen afGain LoRX LoTX enet  enout  nben   nblvl  nren  spot  rbeep pitch   notch  xmit fine VFO-AB  DefMFknob    enc1         enc2         enc3      Zoom_lvl panEn panlvl
    {"ENET ON Config",    0, 0, OFF,  0,  0,  0, BAND2,  OFF, MIC_ON,  30.0,  15,   OFF,   100,   ON,   OFF, 100,  23,  16,   ON,  OFF,  OFF,  NBOFF,  OFF,  OFF,  0.02,  600, NTCHOFF, OFF, OFF,   0,    MFTUNE,     MFTUNE,      AFGAIN_BTN,  ATTEN_BTN,   ZOOMx1, OFF, 50}, // if no encoder is present assign it to 0 and it will be skipped. 
    {"User Config #2",    0, 0, OFF,  0,  0,  0, BAND4,  OFF, MIC_ON,  30.0,  15,   OFF,   100,   ON,   OFF, 100,  23,  16,  OFF,  OFF,  OFF,  NBOFF,  OFF,  OFF,  0.02,  600, NTCHOFF, OFF, OFF,   0,    MFTUNE,     MFTUNE,      AFGAIN_BTN,  RFGAIN_BTN,  ZOOMx1, OFF, 50},
    {"PanAdapter Config", 0, 0, OFF,  0,  0,  0, BAND0,  OFF, MIC_OFF, 30.0,  15,   OFF,   100,   ON,   OFF, 100,  23,  16,  OFF,  OFF,  OFF,  NBOFF,  OFF,  OFF,  0.02,  600, NTCHOFF, OFF, OFF,   0,    MFTUNE,     REFLVL_BTN,  REFLVL_BTN,  RFGAIN_BTN,  ZOOMx1, OFF, 50}
};
