...
// Shared button placement for both RA8875 800x480 and RA8876 1024x600 displays
    ...
    struct Standard_Button std_btn[STD_BTN_NUM] = 
    {
        ...
        { ON,  ON, 1, 1, x_1, y_1, w_1, h_1, r_1, LIGHTGREY, LIGHTGREY, BLACK, BLACK, 20, 20, 255,"Mode\0"},
        { ON,  ON, 1, 2, x_2, y_1, w_1, h_1, r_1, LIGHTGREY, LIGHTGREY, BLACK, BLACK, 21, 20, 255,"Filter\0"},
        { ON,  ON, 1, 3, x_3, y_1, w_1, h_1, r_1, LIGHTGREY, LIGHTGREY, BLACK, BLACK, 24, 20, 255,"Rate\0"},
        { ON,  ON, 1, 4, x_4, y_1, w_1, h_1, r_1, LIGHTGREY, LIGHTGREY, BLUE,  BLACK,  4, 20, 255,"ATT\0"},
        { ON,  ON, 1, 5, x_5, y_1, w_1, h_1, r_1, LIGHTGREY, LIGHTGREY, BLUE,  BLACK,  5, 20, 255,"Preamp\0"},
        { OFF, ON, 1, 6, x_6, y_1, w_1, h_1, r_1, LIGHTGREY, LIGHTGREY, BLACK, BLACK, 20, 20, 255,"Band\0"},
        //Panel 2
        { ON, OFF, 2, 1, x_1, y_1, w_1, h_1, r_1, LIGHTGREY, LIGHTGREY, BLUE,  BLACK, 22, 20, 255,"NB\0"},
        { ON, OFF, 2, 2, x_2, y_1, w_1, h_1, r_1, LIGHTGREY, LIGHTGREY, BLUE,  BLACK, 32, 20, 255,"NR\0"},
        { ON, OFF, 2, 3, x_3, y_1, w_1, h_1, r_1, LIGHTGREY, LIGHTGREY, BLUE,  BLACK, 18, 20, 255,"Notch\0"},
        { ON, OFF, 2, 4, x_4, y_1, w_1, h_1, r_1, LIGHTGREY, LIGHTGREY, BLACK, BLACK,  8, 20, 255,"AGC- \0"},
        { ON, OFF, 2, 5, x_5, y_1, w_1, h_1, r_1, LIGHTGREY, LIGHTGREY, BLUE,  BLACK,  7, 20, 255,"Zoom\0"},
        { ON, OFF, 2, 6, x_6, y_1, w_1, h_1, r_1, LIGHTGREY, LIGHTGREY, BLUE,  BLACK,  5, 20, 255,"Pan\0"},
        //Panel 3
        { ON, OFF, 3, 1, x_1, y_1, w_1, h_1, r_1, LIGHTGREY, LIGHTGREY, BLACK, BLACK, 18, 20, 255,"Menu\0"},
        { ON, OFF, 3, 2, x_2, y_1, w_1, h_1, r_1, LIGHTGREY, LIGHTGREY, BLACK, BLACK, 18, 20, 255,"ANT  \0"},
        { ON, OFF, 3, 3, x_3, y_1, w_1, h_1, r_1, LIGHTGREY, LIGHTGREY, BLUE,  BLACK, 25, 20, 255,"ATU\0"},
        { ON, OFF, 3, 4, x_4, y_1, w_1, h_1, r_1, LIGHTGREY, LIGHTGREY, BLUE,  BLACK, 22, 20, 255,"XMIT\0"},
        ...
        //Panel 4
        { ON, OFF, 4, 1, x_1, y_1, w_1, h_1, r_1, LIGHTGREY, LIGHTGREY, BLUE,  BLACK, 31, 20, 255,"RIT\0"},
        { ON, OFF, 4, 2, x_2, y_1, w_1, h_1, r_1, LIGHTGREY, LIGHTGREY, BLUE,  BLACK, 31, 20, 255,"XIT\0"},   
        { ON, OFF, 4, 3, x_3, y_1, w_1, h_1, r_1, LIGHTGREY, LIGHTGREY, BLUE,  BLACK, 26, 20, 255,"Fine\0"},
        { ON, OFF, 4, 4, x_4, y_1, w_1, h_1, r_1, LIGHTGREY, LIGHTGREY, BLUE,  BLACK, 23, 20, 255,"Split\0"},
        ...
        {OFF, OFF, 5, 4, x_4, y_1, w_1, h_1, r_1, LIGHTGREY, LIGHTGREY, BLUE,  BLACK, 14, 20, 255,"RefLvl\0"},
        { ON, OFF, 5, 5, x_5, y_1, w_1, h_1, r_1, LIGHTGREY, LIGHTGREY, BLUE,  BLACK,  9, 20, 255, "AF:\0"},
        { ON, OFF, 5, 6, x_6, y_1, w_1, h_1, r_1, LIGHTGREY, LIGHTGREY, BLUE,  BLACK, 23, 20, 255, "Mute\0"},
