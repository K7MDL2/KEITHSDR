...
struct Band_Memory bandmem[BANDS] = {
    ...
    { "30M",     9990000,    10150000,    10000000, AM,      10136000, DATA,    10130000,  CW,     10136000, USB,  BW6_0, 6000,  BAND30M,  1, AGC_SLOW,OFF,OFF,OFF,OFF,ANT1, 4,  ATTEN_OFF,  1,   10,  PREAMP_OFF,  5,  ON,   NONE,    NONE,    100,  -10,  0xFFFF},
    { "20M",    14000000,    14350000,    14074000, DATA,    14030000, CW,      14200000,  USB,    14200000, USB,  BW4_0, 4000,  BAND20M,  3, AGC_SLOW,OFF,OFF,OFF,OFF,ANT2, 5,  ATTEN_OFF,  1,   50,  PREAMP_OFF,  5,  ON,   NONE,    NONE,    100,  -10,  0xFFFF},
    { "17M",    18068000,    18168000,    18100000, DATA,    18135000, USB,     18090000,  CW,     18135000, USB,  BW3_2, 3200,  BAND17M,  1, AGC_SLOW,OFF,OFF,OFF,OFF,ANT1, 6,  ATTEN_OFF,  1,   50,  PREAMP_OFF,  5,  ON,   NONE,    NONE,    100,  -10,  0xFFFF},
